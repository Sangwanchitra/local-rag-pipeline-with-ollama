...
2. Upload exactly 2 PDF files (30-50 pages each) on the left sidebar.
3. Click **"Build Index"**. Wait for the embeddings to be generated and stored locally in `data/chroma_db`.
